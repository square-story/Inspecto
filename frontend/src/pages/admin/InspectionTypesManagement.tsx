...
const inspectionTypeFormSchema = z.object({
    name: string()
        .min(2, { message: "Inspection Type name must be at least 2 characters." })
            ...
            <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
                    ...
                    >
                        ...
                        <DialogContent className="sm:max-w-[600px]">
                            <DialogHeader>
                                ...
                                <DialogDescription>Add a new inspection type with details and features.</DialogDescription>
                            </DialogHeader>
                            <Form {...form}>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input placeholder="Inspection Name" {...field} className="w-full" />
                                                        </FormControl>
                                                        <FormMessage />
                                                        <FormDescription>Please provide a valid inspection type name.</FormDescription>
                                                    </FormItem>
                                                )}
                                            />
                                        </div>
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input placeholder="Inspection Price" {...field} className="w-full" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input placeholder="Platform Fee" {...field} className="w-full" />
                                                        </FormControl>
                                                        <FormMessage />
                                                    </FormItem>
                                                )}
                                            ...
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormControl>
                                                            <Input placeholder="e.g. 45-60 mins" {...field} className="w-full" />
                                                        </FormControl>
                                                        <FormMessage />
                                                        <FormDescription>Please provide a valid duration.</FormDescription>
                                                    </FormItem>
                                                )}
                                            />
                                            <FormField
                                                ...
                                                render={({ field }) => (
                                                    <FormItem>
                                                        ...
                                                        <FormMessage />
                                                        <FormDescription>Please provide at least one feature.</FormDescription>
                                                    </FormItem>
                                                )}
                                            />
                                        </div>
                ...
                >
                    <DialogContent className="sm:max-w-[600px]">
                        <DialogHeader>
                            ...
                            <DialogDescription>Modify the inspection type details and features.</DialogDescription>
                        </DialogHeader>
                        <Form {...form}>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>Manage inspection types, pricing, and features</CardDescription>
                    </CardHeader>
                    <CardContent>
                        {loading ? (
