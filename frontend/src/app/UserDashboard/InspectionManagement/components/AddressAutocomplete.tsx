...
const AddressAutocomplete = ({ setValue, closeDialog }: AddressAutocompleteProps) => {
    ...
    useEffect(() => {
        ...
        const fetchAddresses = async () => {
            try {
                ...
                const results = response.data.results.map((place: { formatted: string; geometry: { lat: number; lng: number } }, index: number) => ({
                    id: index.toString(),
    ...
    return (
        <>
            ...
            <Button variant="outline" onClick={fetchLocationFromCoordinates} className="w-full">
